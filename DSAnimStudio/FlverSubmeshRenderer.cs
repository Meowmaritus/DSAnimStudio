    ...
    public class FlverSubmeshRenderer : IDisposable
    {
            ...
            bool ignoreStaticTransforms = false)
        {
            ...
            for (int i = 0; i < mesh.Vertices.Count; i++)
            {
                ...
                if (vert.Colors.Count == 2 && GameDataManager.GameType == SoulsAssetPipeline.SoulsGames.DS2SOTFS)
                {
            ...
            bool ignoreStaticTransforms = false)
        {
            ...
            foreach (var matParam in flvr.Materials[mesh.MaterialIndex].Textures)
            {
                ...
                Vector2 texScaleVal = Vector2.One;// new Vector2(1 / matParam.Scale.X, 1 / matParam.Scale.Y);
