...
namespace SoulsFormats
{
    public partial class PARAM_Hack
    {
        ...
        public class Row
        {
            ...
            /// <summary>
            /// Cells contained in this row. Must be loaded with PARAM_Hack.ApplyParamdef() before use.
            /// </summary>
            ...
            internal void WriteCells(BinaryWriterEx bw, PARAM_Hack parent, int index)
            {
                if (parent.Format2D.HasFlag(FormatFlags1.LongDataOffset))
