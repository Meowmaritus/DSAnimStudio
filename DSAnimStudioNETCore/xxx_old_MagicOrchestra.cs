...
//{
//    public class xxx_old_MagicOrchestra
//    {
...
//                add($"ds_se_{entityName1}");
//                add($"ds_se_{entityName2}");
//                add($"ds_se_main");
//            }
...
//        private static List<string> _bankNameList = null;
...
//        private static Dictionary<MOSoundFileKey, Task<LoadedSoundFile>> soundFileConvertCache = new Dictionary<MOSoundFileKey, Task<LoadedSoundFile>>();

//        private static object _lock_soundFileConvertCache = new object();
...
//        public static LoadedSoundFile LoadSoundFile(MOSoundFileKey key, Func<byte[]> getSoundBytesIfNotLoaded,
...
//        public static byte[] ConvertSoundFiletoWAV(byte[] vag, string extension, string bank, int soundIndex, int vagIndex)
//        {
...
//        private static Dictionary<string, MOSB> loadedMOSBs = new Dictionary<string, MOSB>();
//        private static object _lock_GetMOSB = new object();
//        private static MOSB GetMOSB(string bankName)
//        {
//            MOSB result = null;
...
//                {
//                    _bankNameList = new List<string>();
//                    foreach (var thing in zzz_DocumentManager.CurrentDocument.GameData.GetFilesInDir("/sound/"))
//                    {
//                        var fn = thing.ToLower().Trim();
//                        if (fn.EndsWith(".mosb"))
//                        {
//                            fn = Utils.GetShortIngameFileName(fn);
//                            if (!_bankNameList.Contains(fn))
//                                _bankNameList.Add(fn);
...
//                    lock (_lock_BankNameArray)
//                    {
//                        BankNameArray = _bankNameList.OrderBy(v => v).ToArray();
//                        BankNameArray_SelectedIndex = -1;
//                    }
//                }
//            }
...
//                else
//                {
//                    var bytes = zzz_DocumentManager.CurrentDocument.GameData.ReadFile($"/sound/{bankName}.mosb", warningOnFail: false);
//                    if (bytes != null)
//                    {
...
//        private static Dictionary<string, MOIB> loadedMOIBs = new Dictionary<string, MOIB>();
//        private static object _lock_GetMOIB = new object();
//        private static MOIB GetMOIB(string bankName)
//        {
//            MOIB result = null;
...
//                else
//                {
//                    var bytes = zzz_DocumentManager.CurrentDocument.GameData.ReadFile($"/sound/{bankName}.moib");
//                    if (bytes != null)
//                    {
...
//        private static Dictionary<string, MOWV> loadedMOWVs = new Dictionary<string, MOWV>();
//        private static object _lock_GetMOWV = new object();
//        private static MOWV GetMOWV(string bankName)
//        {
//            MOWV result = null;
...
//        private static Dictionary<string, BND3> loadedMOWBs = new Dictionary<string, BND3>();
//        private static object _lock_GetMOWB = new object();
//        private static BND3 GetMOWB(string bankName)
//        {
//            BND3 result = null;
...
//                else
//                {
//                    var bytes = zzz_DocumentManager.CurrentDocument.GameData.ReadFile($"/sound/{bankName}.mowb");
//                    if (bytes != null)
//                    {
...
//        public static List<MOPlaybackInstance> GetPlaybackInstances(zzz_SoundManagerIns soundMan, SoundPlayInfo info)
//        {
...
//        public static List<MOPlaybackInstance> GetPlaybackInstances(zzz_SoundManagerIns soundMan, List<string> moBankNames, 
//            string sound)
//        {
