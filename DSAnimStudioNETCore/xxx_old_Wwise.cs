...
//{
//    public class xxx_old_Wwise
//    {
//        public static void InitLookupBanks()
//        {
...
//                _bankNameList = null;
//            }
//            GetBankNameFromHash(0);
//            GetBankLookupList(null);
//        }
        
//        public static object _lock_LookupBanks = new object();

//        public static string[] LookupBanks = new string[] {};

//        public static void AddLookupBanks(List<string> addBanks)
//        {
//            var banksList = LookupBanks.ToList();
//            banksList.AddRange(addBanks);
//            LookupBanks = banksList.ToArray();
//        }
        
//        public static int LookupBanks_SelectedIndex = -1;
        
//        private static List<string> GetBankLookupList(SoundPlayInfo info)
//        {
...
//                var entityName2 = Utils.GetShortIngameFileName(zzz_DocumentManager.CurrentDocument.EditorScreen.NewFileContainerName);
//                var entityName1 = info?.SourceModel?.Name ?? entityName2;
...
//        public static string GetBankNameFromHash(uint fnvHash)
//        {
//            string result = null;
//            lock (_lock_bankNameList)
//            {
...
//                    foreach (var thing in zzz_DocumentManager.CurrentDocument.GameData.UxmDictionary)
//                    {
...
//        public static int BankNameArray_SelectedIndex = -1;
//        public static string[] BankNameArray = new string[] {};
//        private static Dictionary<uint, string> _bankNameList = null;
//        private static object _lock_bankNameList = new object();
//        public static object _lock_BankNameArray = new object();
...
//        public static void PurgeLoadedAssets(zzz_SoundManagerIns soundMan)
//        {
...
//        {
//            if (zzz_DocumentManager.CurrentDocument.ParamManager.HitMtrlParamEntries.ContainsKey(materialID) && 
//                !string.IsNullOrWhiteSpace(zzz_DocumentManager.CurrentDocument.ParamManager.HitMtrlParamEntries[materialID]))
//            {
//                return zzz_DocumentManager.CurrentDocument.ParamManager.HitMtrlParamEntries[materialID];
//            }
//            else if (zzz_DocumentManager.CurrentDocument.ParamManager.WwiseValueToStrParam_Switch_DeffensiveMaterial.ContainsKey(materialID) &&
//                !string.IsNullOrWhiteSpace(zzz_DocumentManager.CurrentDocument.ParamManager.WwiseValueToStrParam_Switch_DeffensiveMaterial[materialID].Name))
//            {
//                return zzz_DocumentManager.CurrentDocument.ParamManager.WwiseValueToStrParam_Switch_DeffensiveMaterial[materialID].Name;
//            }
//            else
//            {
...
//            {
//                DefensiveMaterialNames = zzz_DocumentManager.CurrentDocument.ParamManager.WwiseValueToStrParam_Switch_DeffensiveMaterial
//                    .Select(x => $"[{x.Key}] {GetNameOfHitMaterialParam((int)x.Key)} (\"{x.Value.WwiseString}\")")
//                    .ToArray();
//                DefensiveMaterialIDs_ForPlaySoundByFloor = zzz_DocumentManager.CurrentDocument.ParamManager.WwiseValueToStrParam_Switch_DeffensiveMaterial
//                    .Select(x => (int)x.Key).ToArray();
//                ArmorMaterialIdToNameMap = zzz_DocumentManager.CurrentDocument.ParamManager.WwiseValueToStrParam_Switch_DeffensiveMaterial.ToDictionary(p => (int)p.Key, p => p.Value.WwiseString);
//            }
//        }
...
//                else
//                {
//                    if (zzz_DocumentManager.CurrentDocument.GameData.WwiseSoundFileExists($"{bankName}.bnk"))
//                    {
//                        var bytes = zzz_DocumentManager.CurrentDocument.GameData.ReadWwiseSoundFile($"{bankName}.bnk");
//                        if (bytes != null)
//                        {
//                            result = WwiseBNK.Read(bytes);
//                            loadedBanks.Add(bankName, result);
//                            zzz_DocumentManager.CurrentDocument.SoundManager.RegisterAdditionalSoundBank(bankName);
//                        }
//                    }

//                    if (result == null && zzz_DocumentManager.CurrentDocument.GameData.WwiseSoundFileExists($"/enus/{bankName}.bnk"))
//                    {
//                        var bytes = zzz_DocumentManager.CurrentDocument.GameData.ReadWwiseSoundFile($"/enus/{bankName}.bnk");
//                        if (bytes != null)
//                        {
//                            result = WwiseBNK.Read(bytes);
//                            loadedBanks.Add(bankName, result);
...
//        public static List<WemPlaybackInstance> GetPlaybackInstances(zzz_SoundManagerIns soundMan, SoundPlayInfo info)
//        {
//            string sound = GetSoundName(info.SoundType, info.SoundID);
//            if (sound != null)
//            {
//                List<string> bankNames = GetBankLookupList(info);
...
//        public static List<WemPlaybackInstance> GetPlaybackInstances(zzz_SoundManagerIns soundMan, List<string> wwiseBankNames, 
//            string sound)
//        {
...
//            var eventNameHash = Wwise.Hash(sound);
...
//                //}
//                var stopEventNameHash = Hash("Stop" + sound.Substring(4));
...
//                                //return true;
//                            }
//                            else if (zzz_DocumentManager.CurrentDocument.GameData.StreamedWEMExists(captureWemFileID))
//                            {
//                                var captureWemData = zzz_DocumentManager.CurrentDocument.GameData.ReadStreamedWEM(captureWemFileID);
...
//                            {
//                                if (asSwitchCntr.GroupID == Hash(switchGroupHandler.GroupType))
//                                {
//                                    switchID = Hash(switchGroupHandler.SelectedSwitch);
...
//                                else
//                                {
//                                    selectedBankName = GetBankNameFromHash(bankID);
//                                }
//                                //else
//                                //{
...
//                                        zzz_DocumentManager.CurrentDocument.NotificationManager.PushNotification($"Could not find Wwise bank name matching hash '{bankID}'.");
//                                }
//                                else
//                                {
...
//                                    {
//                                        if (Main.Config.Wwise_ShowMissingBankWarnings)
//                                            zzz_DocumentManager.CurrentDocument.NotificationManager.PushNotification($"Wwise sound bank '{selectedBankName}' not found.");
//                                    }
//                                }
...
//                        wwiseSwitchProps[Hash("PlayerEquipmentTops")] = Hash(GetArmorMaterialName_Top());
//                        wwiseSwitchProps[Hash("PlayerEquipmentBottoms")] = Hash(GetArmorMaterialName_Bottom());
//                        wwiseSwitchProps[Hash("DeffensiveMaterial")] = Hash(GetDefensiveMaterialName());
...
//        private static ConcurrentDictionary<string, uint> FnvHashCache = new ConcurrentDictionary<string, uint>();
        
//        public static uint Hash(string input)//, bool use32bits)
//        {
