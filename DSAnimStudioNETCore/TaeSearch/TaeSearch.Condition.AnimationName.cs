...
namespace DSAnimStudio
{
    public partial class TaeSearch
    {
        ...
        {
            public class AnimationName : Condition
            {
                public override ConditionType Type => ConditionType.AnimationName;
                ...
                {
                    string a = check.Anim.SAFE_GetHeaderClone().AnimFileName;
