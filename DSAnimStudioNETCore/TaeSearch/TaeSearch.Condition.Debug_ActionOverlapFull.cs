...
namespace DSAnimStudio
{
    public partial class TaeSearch
    {
        ...
        {
            public class Debug_ActionOverlapFull : Condition
            {
                public override ConditionType Type => ConditionType.Debug_ActionOverlapFull;
                ...
                {
                    bool overlap = check.Anim.SAFE_GetActions().Any(x => x != check.Act && x.Overlaps(check.Act, perfectMatch: true));
