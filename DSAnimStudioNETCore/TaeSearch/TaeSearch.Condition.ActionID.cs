...
namespace DSAnimStudio
{
    public partial class TaeSearch
    {
        ...
        {
            public class ActionID : Condition
            {
                public override ConditionType Type => ConditionType.ActionID;
                ...
                {
                    int actualOperand = Convert.ToInt32(Operand);
                    return OperatorEvaluator.EvaluateInteger(check.Act.Type, Operator, actualOperand);
                }
            }
        }
    }
