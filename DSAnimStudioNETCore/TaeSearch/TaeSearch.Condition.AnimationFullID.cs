...
namespace DSAnimStudio
{
    public partial class TaeSearch
    {
        ...
        {
            public class AnimationFullID : Condition
            {
                public override ConditionType Type => ConditionType.AnimationFullID;
                ...
                {
                    int actualOperand = Convert.ToInt32(Operand);
                    return OperatorEvaluator.EvaluateInteger(check.Anim.SplitID.GetFullID(proj), Operator, actualOperand);
                }
            }
        }
    }
