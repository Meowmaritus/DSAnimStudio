...
namespace DSAnimStudio
{
    public partial class TaeSearch
    {
        ...
        {
            public class AnimationCategoryName : Condition
            {
                public override ConditionType Type => ConditionType.AnimationCategoryName;
                ...
                {
                    string a = check.Category.Info.DisplayName;
