...
namespace DSAnimStudio
{
    public partial class TaeSearch
    {
        ...
        {
            public class ParameterName : Condition
            {
                public override ConditionType Type => ConditionType.ParameterName;
                public override ConditionDepthType Depth => ConditionDepthType.CategoryAnimationTrackActionParameter;
